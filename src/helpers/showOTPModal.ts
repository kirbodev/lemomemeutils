import { ModalBuilder, TextInputBuilder, ActionRowBuilder, TextInputStyle, ChatInputCommandInteraction, ButtonInteraction, EmbedBuilder } from "discord.js";
...
export default async function showOTPModal(interaction: ChatInputCommandInteraction | ButtonInteraction, secret: string) {
    const id = nanoid();
