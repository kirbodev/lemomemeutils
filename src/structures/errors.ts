enum Errors {
  ...
  ErrorCooldown = "⏲️ Slow down! You're doing that too fast",
  ErrorDevOnly = "🛠️ That command is only available to developers",
  ErrorOTPRequired = "🔑 You need to enable OTP to use this command",
  ErrorOTPExpired = "🔑 Your OTP has expired",
  ErrorTestOnly = "🧪 That command is only available in the test server",
  ErrorMaintainanceMode = "🔧 That command is currently unavailable",
  ...
  ErrorCommandNotFound = "🤔 I couldn't find that command",
  ErrorUserMuted = "🤐 That user is already muted",
